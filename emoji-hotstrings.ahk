...
; ===== Auto-generated Emoji Shortcuts =====
; === EMOJI HOTSTRINGS START ===
::;hash::
    Send #️⃣
return
...
::;rightwards_pushing_hand::
    Send 🫸
return
; === EMOJI HOTSTRINGS END ===


^!e::Gosub, OpenEmojiGui   ; Ctrl+Alt+E
return

OpenEmojiGui:
    Gui, New, +AlwaysOnTop, Add Emoji Shortcut
    Gui, Add, Text,, Emoji:
    Gui, Add, Edit, vEmoji w120
    Gui, Add, Text,, Shortcut (without ::):
    Gui, Add, Edit, vShortcut w200, ;example
    Gui, Add, Button, gAddEmojiShortcut w140, Add + Reload
    Gui, Show
return
...
AddEmojiShortcut:
	...
	startMarker := "; === EMOJI HOTSTRINGS START ==="
	endMarker   := "; === EMOJI HOTSTRINGS END ==="

	FileRead, src, %A_ScriptFullPath%

	sPos := InStr(src, startMarker)
